 ...
 * @author JeanLugo
 */
@WebServlet(urlPatterns = {"/Controlador3"})
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("3".equals(vav)){
            ...
            try {   
                ...
                sta.executeUpdate(insertar + "VALUES ('"+ nombre +"', '"+ correo +"', '"+ contra +"' , '"+ cumple +"', 'normal')");
            ...
            String insertar2 = "INSERT INTO ROOT.\"USUARIONORMAL\" (NOMBRE, DOMICILIO, NUMEROEM)";
            try {
                Connection cnx;
                Statement sta;
                Class.forName("org.apache.derby.jdbc.ClientDriver");
                ...
                sta.executeUpdate(insertar2 + "VALUES ('"+ nombre +"', '"+ dom +"', "+ numemp +")");
            ...
            out.println("<br>");
            out.println("<br>");
            out.println("<a href='LoginNormal.html'>Inicie sesión</a>");
            out.println("</fieldset>");
            out.println("</body>"); 
            out.println("</html>"); 
            }
        }else if("5".equals(vav) ){
            ...
            if (co.getCheck()){
                ...
                out.println("<br><a href='RegistroNormal.html'>Inicio</a>");
                out.println("</fieldset>");
                out.println("</body>"); 
                out.println("</html>"); 
