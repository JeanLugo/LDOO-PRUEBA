    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if ("2".equals(vav)){
            ...
            try {   
                ...
                sta.executeUpdate(insertar + "VALUES ('"+ nombre +"', '"+ correo +"', '"+ contra +"' , '"+ cumple +"', 'invitado')");
            ...
            String insertar2 = "INSERT INTO ROOT.\"INVITADOS\" (NOMBRE, FECHARE)";
            try {
                Connection cnx;
                Statement sta;
                Class.forName("org.apache.derby.jdbc.ClientDriver");
                ...
                sta.executeUpdate(insertar2 + "VALUES ('"+ r.getUsername() +"', '"+ date.format(now) +"')");
            ...
            out.println("<br>");
            out.println("<br>");
            out.println("<a href='LoginInvitado.html'>Inicie sesión</a>");
            out.println("</fieldset>");
            out.println("</body>"); 
            out.println("</html>"); 
            }
        }else if("4".equals(vav) ){
            ...
            if (co.getCheck()){
                ...
                out.println("<br><a href='RegistroInvitado.html'>Inicio</a>");
                out.println("</fieldset>");
                out.println("</body>"); 
                out.println("</html>"); 
